            ...
            {isMobile ?
              <Col md={7} className="home-header">
                <h1 className="heading-name">
                  Shahzaib <strong className="main-name">Hassan</strong>
                </h1>
                <div style={{ paddingLeft: 50, fontSize: 25 }}>Jr. Frontend Developer</div>
              ...
              <Col md={7} className="home-header">
                <h1 style={{ paddingBottom: 15, paddingLeft: 50, fontSize: 70 }}>
                  Hey, I'm <strong className="main-name">Shahzaib</strong>
                </h1>
                <div style={{ paddingLeft: 50, fontSize: 25 }}>Jr. Frontend Developer</div>
                <div style={{ padding: 50, textAlign: "left" }}>
                  <TextWriting />
